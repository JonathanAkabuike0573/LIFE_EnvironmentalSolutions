...
2.  [Bill of Materials (BOM)](#bill_of_materials_bom)
3.  [Hardware Assembly](#hardware_assembly)
4.  [Raspberry Pi Setup](#raspberry_pi_setup)
5.  [Firebase Configuration](#firebase_configuration)
6.  [Python Code Setup](#python-code-setup)
7.  [Android App Integration](#android_app_integration)
8.  [PCB Design (Optional)](#pcb_design_optional)
9.  [3D Printed Case (Optional)](#bm_3d_printed_case_optional)
...
[]{#bill_of_materials_bom .anchor}**Bill of Materials (BOM)**
...
[]{#hardware_assembly .anchor}**Hardware Assembly**
...
[]{#raspberry_pi_setup .anchor}**Raspberry Pi Setup**
...
[]{#firebase_configuration .anchor}**Firebase Configuration**
...
[]{#python_code_setup .anchor}**Python Code Setup**
...
[]{#android_app_integration .anchor}**Android App Integration**
